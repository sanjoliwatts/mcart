package com.project.mcartcartdetails.utility;
...
@EnableJpaRepositories("com.project.mcartcartdetails.repository") 
...
public class DatabaseConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(Environment env) {
		...
		em.setPackagesToScan("com.project.mcartcartdetails");
