package com.project.mcartorderdetails.utility;
...
@EnableJpaRepositories("com.project.mcartorderdetails.repository") 
...
public class DatabaseConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(Environment env) {
		...
		em.setPackagesToScan("com.project.mcartorderdetails");
